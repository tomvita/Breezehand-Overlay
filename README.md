...
2. **Choose Your Installation Method**:
   ...
   **Option A: With Ultrahand Overlay Manager** (Recommended for multiple overlays):
   ...
   **Option B: Standalone** (Cheat management only):
   - Download `breezehand.ovl` from [Releases](https://github.com/tomvita/Breezehand-Overlay/releases/latest)
   - Rename it to `ovlmenu.ovl` and place it in `/switch/.overlays/`
   - This gives you a lightweight setup with just cheat management functionality, no overlay manager needed
